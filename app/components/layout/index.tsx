// master layout component to support
// 1 and 2 column layouts

// boolean prop "firstGridItem" toggles 1 or 2 column layout

// xs={12} renders 2 Grid Items as 1 column and 2 rows
// on browsers with a width of less than 600px

// sm={2} and sm={10}
// for browsers with width > 600px, container will show
// 2 Grid Items as 2 columns and 1 row
...
class Layout extends React.Component<Props> {
    public render() {
        ...
        return (
            <Grid container direction="row" justify="flex-start" alignItems="stretch" style={isMobile ? styleGridIsMobile : styleGrid}>
                {firstGridItem ? (
                    <Grid
                        item
                        sm={2}
